...
from yara_app.ttbot.dispatch import BrowserResources, DispatchService
from yara_app.ttbot.models import BrowserRuntimePolicy, ChatOpenMethod, ChatOpenResult, DispatchSettings, Target
from yara_app.ttbot.models import AppSettings, NotificationSettings, ProfileConfig
...
class DispatchServiceTests(unittest.TestCase):
    ...
    def test_process_target_updates_store_on_success(self):
        ...
        self.assertEqual(session.sent, ['вќ¤пёЏ'])
    ...
    def test_run_summary_file_written(self):
        service = self.build_service(dry_run=True)
        from yara_app.ttbot.models import RunSummary
