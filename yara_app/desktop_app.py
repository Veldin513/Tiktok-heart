...
APP_ID = 'com.tiktokheart.bot.controlcenter'
from tkinter import messagebox

from yara_app.runtime_paths import bootstrap_site_packages

bootstrap_site_packages()

from yara_app.diagnostics_app import DiagnosticsApp
from yara_app.single_instance import SingleInstanceGuard
from yara_app.tray_support import TrayCallbacks, TrayIconController
...
def main() -> None:
    lock_path = PROJECT_ROOT / '.desktop_app.lock'
